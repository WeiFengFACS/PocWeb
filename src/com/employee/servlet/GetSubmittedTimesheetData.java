...
/**
 * Servlet implementation class GetSubmittedTimesheetData
 */
@WebServlet("/GetSubmittedTimesheetData")
public class GetSubmittedTimesheetData extends HttpServlet {
     ...
     */
    public GetSubmittedTimesheetData() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (operation.equals("getTotalNumber")) {
			...
			try {
				...
				st = "SELECT * FROM timesheets WHERE email = '" + userName + "' and submit != 'Not Due Yet'";
