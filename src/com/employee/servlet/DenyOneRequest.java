...
/**
 * Servlet implementation class DenyOneRequest
 */
@WebServlet("/DenyOneRequest")
public class DenyOneRequest extends HttpServlet {
	private static final long serialVersionUID = 1L;
	static String message = null;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DenyOneRequest() {
        super();
...
//System.out.println("username is " + userName);
		if (empNotApproval == null) {
			...
			if (ValidationUtility.checkEmailExisted(empNotApproval, userName)) {
				...
				DBUtility.deleteEmpSql(role, userName);
				message = "You have denied this requests!";
