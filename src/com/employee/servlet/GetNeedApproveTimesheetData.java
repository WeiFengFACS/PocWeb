...
/**
 * Servlet implementation class GetNeedApproveTimesheetData
 */
@WebServlet("/GetNeedApproveTimesheetData")
public class GetNeedApproveTimesheetData extends HttpServlet {
	 ...
	 */
	public GetNeedApproveTimesheetData() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		if (operation.equals("getTotalNumber")) {
			...
			try {
				...
				st = "SELECT * FROM timesheets WHERE email = '" + userName + "' and submit = 'Pending for Approval'";
			...
			try {
				stmt = conn.createStatement();
				st = "SELECT * FROM timesheets WHERE email = '" + userName + "' and submit = 'Pending for Approval'"
						+ " GROUP BY date DESC limit " + startPage + " , "
						+ pageSize;
				System.out.println(st);
				rs = stmt.executeQuery(st);
